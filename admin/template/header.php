	...
	<section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.php" class="logo"><b><?php echo $supermarket['nama_supermarket'];?></b> <small style="padding-left:5px;font-size:13px;"><?php echo $supermarket['alamat_supermarket'];?></small></a>
            <!--logo end-->

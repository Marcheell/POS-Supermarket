...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2022 at 03:38 PM
...
(1, 'Mr Lee', 'Wakanda', '085260614340', 'lee163534@gmail.com', 'profile2.jpg', '08526061');
...
CREATE TABLE `supermarket` (
  ...
  `alamat_supermarket` text NOT NULL,
...
INSERT INTO `supermarket` (`id_supermarket`, `nama_supermarket`, `alamat_supermarket`, `tlp`, `nama_pemilik`) VALUES
(1, 'COREMART', 'Wakanda', '082369333642', 'Mr Lee');
...
--
ALTER TABLE `supermarket`
  MODIFY `id_supermarket` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
